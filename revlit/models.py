...
class Articles(models.Model):
    ...
    variable2 = models.BooleanField(default=False, verbose_name="collected during adolescence?")
    variable3 = models.BooleanField(default=False, verbose_name="collected during adulthood?")
