...
class Articles(models.Model):
    ...
    ratiomfa = models.CharField(blank=True, null=True, max_length=250, verbose_name="14-a Males / Females")
    ratiomfb = models.CharField(blank=True, null=True, max_length=250, verbose_name="14-b Males / Females")
    ratiomfc = models.CharField(blank=True, null=True, max_length=250, verbose_name="14-c Males / Females")
    ratiomfd = models.CharField(blank=True, null=True, max_length=250, verbose_name="14-d Males / Females")
    agea = models.CharField(blank=True, null=True, max_length=250, verbose_name="15-a Ages (mean; SD; range)")
    ageb = models.CharField(blank=True, null=True, max_length=250, verbose_name="15-b Ages (mean; SD; range)")
    agec = models.CharField(blank=True, null=True, max_length=250, verbose_name="15-c Ages (mean; SD; range)")
    aged = models.CharField(blank=True, null=True, max_length=250, verbose_name="15-d Ages (mean; SD; range)")
    paysrecruta = models.CharField(blank=True, null=True, max_length=250, verbose_name="17-a Country where data was collected")
    paysrecrutb = models.CharField(blank=True, null=True, max_length=250, verbose_name="17-b Country where data was collected")
    paysrecrutc = models.CharField(blank=True, null=True, max_length=250, verbose_name="17-c Country where data was collected")
    paysrecrutd = models.CharField(blank=True, null=True, max_length=250, verbose_name="17-c Country where data was collected")
    ethnoa = models.CharField(blank=True, null=True, max_length=250, verbose_name="16-a Ethno-racial group")
    ethnob = models.CharField(blank=True, null=True, max_length=250, verbose_name="16-b Ethno-racial group")
    ethnoc = models.CharField(blank=True, null=True, max_length=250, verbose_name="16-c Ethno-racial group")
    ethnod = models.CharField(blank=True, null=True, max_length=250, verbose_name="16-d Ethno-racial group")
    educationa = models.CharField(blank=True, null=True, max_length=250, verbose_name="18-a Education")
    educationb = models.CharField(blank=True, null=True, max_length=250, verbose_name="18-b Education")
    educationc = models.CharField(blank=True, null=True, max_length=250, verbose_name="18-c Education")
    educationd = models.CharField(blank=True, null=True, max_length=250, verbose_name="18-d Education")
    ...
    variable1t = models.TextField(blank=True, null=True, verbose_name="50a- Variables in the trajectories during childhood")
    variable2t = models.TextField(blank=True, null=True, verbose_name="51a- Variables in the trajectories during adolescence")
    variable3t = models.TextField(blank=True, null=True, verbose_name="52a- Variables in the trajectories during adulthood")
    variable10t = models.TextField(blank=True, null=True, verbose_name="Duration of the prospective longitudinal study(years)")
    variable4t = models.TextField(blank=True, null=True, verbose_name="53a- End in expressive violence")
    variable5t = models.TextField(blank=True, null=True, verbose_name="54a- End in instrumental violence")
    variable6t = models.TextField(blank=True, null=True, verbose_name="55a- End in ritualized violence")
    variable7t = models.TextField(blank=True, null=True, verbose_name="56a- End in non specified violence")
    variable8t = models.TextField(blank=True, null=True, verbose_name="57a- Not specified")
    variable9 = models.TextField(blank=True, null=True, verbose_name="58- List of variables used in the trajectories")
    variable11 = models.TextField(blank=True, null=True, verbose_name="59- Operationalized violence")
