...
class Articles(models.Model):
    ...
    otherdata = models.CharField(blank=True, null=True, max_length=250, verbose_name="9c1- List of psychometric tests (if applicable)")
    ...
    variable1t = models.CharField(blank=True, null=True, max_length=250, verbose_name="50a- Variables in the trajectories during childhood")
    variable2t = models.CharField(blank=True, null=True, max_length=250, verbose_name="51a- Variables in the trajectories during adolescence")
    variable3t = models.CharField(blank=True, null=True, max_length=250, verbose_name="52a- Variables in the trajectories during adulthood")
