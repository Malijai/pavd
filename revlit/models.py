...
class Articles(models.Model):
    ...
    designquanti1 = models.ForeignKey(Quanti, null=True,blank=True, related_name='quanti1', on_delete=models.DO_NOTHING, verbose_name="9a- Study design (if quantitative)")
    designquanti2 = models.ForeignKey(Quanti, null=True,blank=True, related_name='quanti2', on_delete=models.DO_NOTHING, verbose_name="9b- Study design (if quantitative)")
    ...
    trajectoire1 = models.TextField(blank=True, null=True, max_length=250, verbose_name="Trajectoire 1")
    trajectoire2 = models.TextField(blank=True, null=True, max_length=250, verbose_name="Trajectoire 2")
    trajectoire3 = models.TextField(blank=True, null=True, max_length=250, verbose_name="Trajectoire 3")
    trajectoire4 = models.TextField(blank=True, null=True, max_length=250, verbose_name="Trajectoire 4")
    trajectoire5 = models.TextField(blank=True, null=True, max_length=250, verbose_name="Trajectoire 5")
    trajectoire6 = models.TextField(blank=True, null=True, max_length=250, verbose_name="Trajectoire 6")
    trajectoire7 = models.TextField(blank=True, null=True, max_length=250, verbose_name="Trajectoire 7")
    limitations = models.TextField(blank=True, null=True, max_length=250, verbose_name="Limitations")
